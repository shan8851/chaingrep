...
import { getConnectionStorageStatus } from "../lib/connectionStorageStatus";
...
type SettingsPanelProps = {
  ...
  savedSettings: UserConnectionSettings;
...
export const SettingsPanel = ({
  ...
  const etherscanStorageStatus = getConnectionStorageStatus(
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-4">
                {supportedChains.map((chainConfig) => {
                  const rpcStorageStatus = getConnectionStorageStatus(
                    savedSettings.rpcUrlsByChainId[String(chainConfig.id)],
                    settings.rpcUrlsByChainId[String(chainConfig.id)]
                  );
                    ...
                    >
                      <div className="mb-3 flex items-center justify-between gap-3">
                        ...
                        <div className="flex flex-wrap items-center justify-end gap-2">
                          <Badge tone={rpcStorageStatus.tone}>{rpcStorageStatus.label}</Badge>
